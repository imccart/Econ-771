...
Today we'll look at a couple of papers that study how changes in one healthcare segement (e.g., public insurance policies) affect other segments (e.g., commercial insurance patients). Clements and Gottlieb (2017) is about spillovers from public payment policies onto the commercial insurance market, and Baicker, Chernew, and Robbins (2013) is about spillovers from Medicare managed care (the private insurance component of Medicare) onto Medicare patients. 
