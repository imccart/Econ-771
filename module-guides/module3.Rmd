...
# Overview 
This is the guide for **Module 3**, which covers transparency and information disclosure in healthcare. 
...
Grennan and Swanson (2020) study the effects of a "benchmarking database" in which hospitals could observe statistics on prices paid for various medical devices.
