...
\begin{equation}
DSH_{ht} = \beta_{1} Expand_{s} + \beta_{2} 1(t\geq 2014) + \beta_{3} Expand_{s} \times 1(t\geq 2014) + \beta_{4} ForProfit_{h} + \delta ForProfit_{h} \times Expand_{s} \times 1(t\geq 2014) +  \varepsilon_{ht}, (\#eq:ddd)
\end{equation}
...
stargazer(ddd.est, label="tab:ddd-regs",
          ...
          font.size="scriptsize",
          no.space=TRUE,
          covariate.labels = c("After 2014","Expansion","Treatment","Ever FP","Treat x FP"),
          dep.var.labels = "Disproportionate Share",
