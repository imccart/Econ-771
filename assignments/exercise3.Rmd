...
# Resources and data
The data for this assignment comes from the AEJ: Policy website, where Keith Ericson's complete dataset is available. The data are available [here](https://www.aeaweb.org/articles?id=10.1257/pol.6.1.38). I've also uploaded the replication files to our AWS AMI under the folder "Ericson (2014)".
...
4. Summarize the relationship between enrollment and market shares in 2006 on premiums in 2007.

5. Use the Part D low-income subsidy as an IV in a fuzzy RD to examine the effect of a boost in enrollments in 2006 on premiums in 2007.
